...
<div class="user-sidebar style--xl">
    ...
    <ul class="user-sidebar-menu">
        ...
        <li><a href="{{route('user.deposit')}}" class="{{ menuActive(['user.deposit','user.deposit.history']) }}"><i class="las la-credit-card pr-1" aria-hidden="true"></i>
                 @lang('Deposit')</a></li>
        ...
        @endif
        <li><a href="{{route('ticket')}}" class="{{ menuActive('ticket') }}"><i class="las la-ticket-alt pr-1" ></i>@lang('Support Ticket')</a></li>
