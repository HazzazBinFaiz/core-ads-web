                ...
                <div class="account-card">
                    <div class="account-card__header bg_img overlay--one"
                        ...
                        <h2 class="section-title">{{ __(@$registerContent->data_values->heading_w) }} <span
                                class="base--color">{{ __(@$registerContent->data_values->heading_c) }}</span>
                        </h2>
                        ...
                        <form action="{{ route('user.register') }}" method="POST"
                            ...
                            @if($general->agree)
                                <div class="form-group form--check">
                                    ...
                                    <label class="form-check-label" for="agree">@lang('I agree with') @foreach($policyPages as $policy) <a
                            ...
                            <p class="mb-0">@lang('Already have an account?') <a
