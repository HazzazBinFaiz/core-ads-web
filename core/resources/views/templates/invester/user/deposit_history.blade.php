...
<div class="dashboard-inner">
    <div class="mb-4">
        <div class="d-flex justify-content-between">
            ...
            <span>
                <a href="{{ route('user.deposit') }}" class="btn btn--secondary btn--smd">@lang('Deposit Now') <i class="las la-long-arrow-alt-right"></i></a>
            </span>
        </div>
    </div>
                    ...
                    <div class="accordion-body">
                        <ul class="caption-list">
                            ...
                            <li>
                                ...
                                <span class="value">
                                    @php echo $deposit->statusBadge @endphp @if($deposit->method_code >= 1000) <a href="javascript:void(0)" class="detailBtn"
                                    data-info="{{ $details }}"
                                    @if ($deposit->status == 3)
                                        data-admin_feedback="{{ $deposit->admin_feedback }}"
                                    @endif
                                    ><i class="las la-info-circle"></i></a> @endif
                                </span>
                            </li>
                        </ul>
                    </div>
