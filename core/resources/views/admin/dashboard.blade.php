...
@section('panel')
    ...
    <div class="alert border border--primary" role="alert">
        ...
        <p class="alert__message">
            ...
            <small><i>@lang('No interest will be provided today.') @if(!$general->holiday_withdraw) @lang('Also withdrawal requests is disable for today.') @endif @lang('The next working is') {{ $nextWorkingDay }}</i></small>
        </p>
        <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close">
