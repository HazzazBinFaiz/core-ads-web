...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'report', 'depositsMonth', 'withdrawalMonth', 'months', 'trxReport', 'plusTrx', 'minusTrx', 'isHoliday', 'nextWorkingDay', 'invest'));
    }
